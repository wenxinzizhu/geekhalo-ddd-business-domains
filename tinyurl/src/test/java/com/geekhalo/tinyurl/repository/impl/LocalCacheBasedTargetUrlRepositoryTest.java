...
public class LocalCacheBasedTargetUrlRepositoryTest extends AbstractTargetUrlRepositoryTest {
    @Autowired
    private LocalCacheBasedTargetUrlRepository tinyUrlRepository;
