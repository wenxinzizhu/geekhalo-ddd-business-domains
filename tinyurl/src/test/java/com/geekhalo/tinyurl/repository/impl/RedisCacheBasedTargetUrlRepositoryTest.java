...
public class RedisCacheBasedTargetUrlRepositoryTest extends AbstractTargetUrlRepositoryTest {
    @Autowired
    private RedisCacheBasedTargetUrlRepository tinyUrlRepository;
